        ...
        <div className="p-6 overflow-y-auto flex-1">
          ...
          {step === 'shipping' && (
            <form onSubmit={handleProceedToPayment} className="space-y-5 text-xs">
              ...
              {/* 1-Click Google VIP Express Checkout Auto-Fill */}
              <button
                type="button"
                onClick={() => {
                  playChimeSound();
              ...
              >
                ...
                <span>⚡ Express VIP Auto-Fill with Google</span>
              </button>

              <div className="flex items-center gap-3">
                <div className="h-[1px] flex-1 bg-[#2d2d30]" />
                <span className="text-[10px] uppercase font-bold text-[#86868b]">or enter shipping address manually</span>
                <div className="h-[1px] flex-1 bg-[#2d2d30]" />
              </div>
