        ...
        <div className="p-6 overflow-y-auto flex-1 text-xs">
          {step === 'form' ? (
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* 1-Click Google Trade Partner Fast Verification */}
              <button
                type="button"
                onClick={() => {
                  playChimeSound();
                  ...
                  setForm(prev => ({
                    ...
                    email: user.email,
                    phone: user.phone || '+91 98201 88492'
                  }));
                  confetti({ particleCount: 70, spread: 60 });
                }}
                className="w-full py-2.5 px-4 rounded-xl bg-white hover:bg-slate-100 text-slate-900 font-bold text-xs flex items-center justify-center gap-2 transition-all shadow-md cursor-pointer active:scale-[0.98]"
              >
                ...
                <span>⚡ 1-Click Fast Partner Verification with Google</span>
              </button>

              <div className="flex items-center gap-3">
                <div className="h-[1px] flex-1 bg-[#2d2d30]" />
                <span className="text-[10px] uppercase font-bold text-[#86868b]">or enter trade details manually</span>
                <div className="h-[1px] flex-1 bg-[#2d2d30]" />
              </div>
